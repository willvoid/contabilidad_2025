 ...
 * @author cmendieta
 */
public class GUICuentaContable extends javax.swing.JDialog {

    /**
     * Creates new form GUIMarca
     */
    public GUICuentaContable(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GUICuentaContable.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                GUICuentaContable dialog = new GUICuentaContable(new javax.swing.JFrame(), true);
